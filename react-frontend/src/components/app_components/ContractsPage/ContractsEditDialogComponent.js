...
renewalType: _entity?.renewalType,
status: _entity?.status,
contractOwner: _entity?.contractOwner,
        };

        setLoading(true);
        try {
            
        const result = await client.service("contracts").patch(_entity._id, _data);
        props.onHide();
