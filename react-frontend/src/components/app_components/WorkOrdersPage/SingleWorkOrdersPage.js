...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Related Contract</label><p className="m-0 ml-3" >{_entity?.relatedContract}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Vendor Name</label><p className="m-0 ml-3" >{_entity?.vendorName}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Work Type</label><p className="m-0 ml-3" >{_entity?.workType}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Assigned To</label><p className="m-0 ml-3" >{_entity?.assignedTo}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Priority</label><p className="m-0 ml-3" >{_entity?.priority}</p></div>
