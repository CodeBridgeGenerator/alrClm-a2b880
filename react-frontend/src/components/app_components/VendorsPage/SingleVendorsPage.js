...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Phone No</label><p className="m-0 ml-3" >{_entity?.phoneNo}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Registration No</label><p className="m-0 ml-3" >{_entity?.registrationNo}</p></div>
