...
const pTemplate3 = (rowData, { rowIndex }) => <p >{rowData.phoneNo}</p>
const pTemplate4 = (rowData, { rowIndex }) => <p >{rowData.address}</p>
const pTemplate5 = (rowData, { rowIndex }) => <p >{rowData.registrationNo}</p>
const p_dateTemplate6 = (rowData, { rowIndex }) => <p >{moment(rowData.contractStartDate).fromNow()}</p>
const p_dateTemplate7 = (rowData, { rowIndex }) => <p >{moment(rowData.contractEndDate).fromNow()}</p>
...
<Column field="phoneNo" header="Phone No" body={pTemplate3} filter={selectedFilterFields.includes("phoneNo")} hidden={selectedHideFields?.includes("phoneNo")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="registrationNo" header="Registration No" body={pTemplate5} filter={selectedFilterFields.includes("registrationNo")} hidden={selectedHideFields?.includes("registrationNo")}  sortable style={{ minWidth: "8rem" }} />
<Column field="contractStartDate" header="Contract Start Date" body={p_dateTemplate6} filter={selectedFilterFields.includes("contractStartDate")} hidden={selectedHideFields?.includes("contractStartDate")}  sortable style={{ minWidth: "8rem" }} />
<Column field="contractEndDate" header="Contract End Date" body={p_dateTemplate7} filter={selectedFilterFields.includes("contractEndDate")} hidden={selectedHideFields?.includes("contractEndDate")}  sortable style={{ minWidth: "8rem" }} />
